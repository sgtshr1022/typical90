...
[問題一覧 公式 ] https://atcoder.jp/contests/typical90/tasks 

難易度 ★ の低い順に並べています。解けたら `- [ ]` を `- [x]` に書き換えてコミット・プッシュしてください。
...
- [x] [004 Cross Sum（★2）] https://atcoder.jp/contests/typical90/tasks/typical90_d 
...
1. 解いたら該当行の `- [ ] ` を `- [x] ` に変更
2. 「解答済み: 0 / 90」の数字も更新
3. コミットメッセージ例: `Solve #004 Cross Sum (★2 `
4. 問題ごとに `001_yokan_party/` のようなフォルダを作り、解答コードとメモを保存
